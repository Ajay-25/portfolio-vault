...
export const AGENT_TOOLS = [
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        ppfWithdrawalAvailable: { type: "number", description: "PPF partial withdrawal limit ₹ (from passbook)" },
        isin:           { type: "string" },
  ...
  },
  {
    ...
    description:
      "Partial update — pass ONLY changed fields as FLAT top-level args. NEVER nest fields_to_update. " +
      'Example: {"keyword":"ppf","portfolio":"mine","rate":"7.1"} or {"id":"fi-xxx","maturityDate":"2027-12-01"}.',
    parameters: {
      type:                 "object",
      additionalProperties: true,
      properties: {
        id:               { type: "string", description: "Record ID from find_fi_holding" },
        keyword:          { type: "string", description: "Search keyword if ID unknown" },
        portfolio:        { type: "string", enum: ["mine", "mother"] },
        fields_to_update: {
          type:                 "object",
          additionalProperties: true,
          description:          "Optional patch object — prefer flat top-level fields instead",
        },
        label:            { type: "string" },
        institution:      { type: "string" },
        accountNumber:    { type: "string" },
        ...
        monthlyContrib:   { type: "number" },
        maturityAmount:   { type: "number" },
        compoundingFreq:  { type: "string" },
        interestPayout:   { type: "string" },
        autoRenewal:      { type: "boolean" },
        isTaxSaving:      { type: "boolean" },
        uan:              { type: "string" },
        employerName:     { type: "string" },
        ...
        pran:             { type: "string" },
        fundManager:      { type: "string" },
        investmentChoice: { type: "string" },
        equityPct:        { type: "number" },
        corpBondPct:      { type: "number" },
        govtSecPct:       { type: "number" },
        altPct:           { type: "number" },
        extensionCount:   { type: "number" },
        ppfWithdrawalAvailable: { type: "number", description: "PPF partial withdrawal limit ₹" },
        isin:             { type: "string" },
        couponFrequency:  { type: "string" },
        rating:           { type: "string" },
        nextCouponDate:   { type: "string" },
